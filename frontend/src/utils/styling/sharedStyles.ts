...
export const h2 = "text-3xl align-middle fw-bold";
export const h3 = "text-2xl align-middle fw-bold";
export const h4 = "text-xl  align-middle fw-bold mb-1";  // (used for individual form headers)
...
export const colStyle = "flex flex-col gap-[2rem] items-center px-[1rem] pt-[2rem] bg-gray-100 md:min-h-[95vh] pb-[15vh]"
